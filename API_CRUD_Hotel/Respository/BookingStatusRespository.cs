...
{
    public class BookingStatusRespository : BaseRepository<BookingStatus>, IBookingStatus
    {
        ...
        public BookingStatus GetBookingStatusWithId(Guid BookingStatusID)
        {
            return base.GetById(BookingStatusID);
        }

        public IEnumerable<BookingStatus> GetAllBookingStatus()
        {
            return this.GetAll();
        }
