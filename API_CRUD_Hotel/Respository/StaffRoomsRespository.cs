...
{
    internal class StaffRoomsRespository : BaseRepository<StaffRooms> ,IStaffRooms
    {
        private HotelsDbContext _hotelDbContext;
        public StaffRoomsRespository(HotelsDbContext hotelsDbContext) : base(hotelsDbContext)
        {
        ...
        public IEnumerable<StaffRooms> GetAllStaffRooms()
        {
            return this.GetAll();
        }
