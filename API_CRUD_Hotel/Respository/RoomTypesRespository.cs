...
{
    internal class RoomTypesRespository : BaseRepository<RoomTypes>, IRoomTypes
    {
        private HotelsDbContext _hotelDbContext;
        public  RoomTypesRespository(HotelsDbContext hotelsDbContext) : base(hotelsDbContext)
        {
        ...
        public  IEnumerable<RoomTypes> GetAllRoomTypes()
        {
            return this.GetAll();
        }
