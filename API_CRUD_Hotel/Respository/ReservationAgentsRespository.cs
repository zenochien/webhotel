...
{
    public class ReservationAgentsRespository : BaseRepository<ReservationAgents>, IReservationAgents
    {
        ...
        public IEnumerable<ReservationAgents> GetAllReservationAgents()
        {
            return this.GetAll();
        }
